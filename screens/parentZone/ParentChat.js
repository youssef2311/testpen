...
export default class _ParentChat extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      calls: [
        ...
        { id: 11, name: "oknice", date: "12 jan", time: '09:28 am', video: false, image: "https://bootdey.com/img/Content/avatar/avatar1.png" },
      ]
    };
  }
  // _onPressButton() {
...
const ParentChat = connect(mapStateToProps)(
  _ParentChat
)
